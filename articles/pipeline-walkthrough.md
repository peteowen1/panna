...
#> [08:29:03] Processing 81 splints...
#> [08:29:03] Including 50 players (>= 45 minutes)
#> [08:29:03] Replacement pool: 0 players (< 45 minutes)
#> [08:29:03] Building row data (vectorized)...
#> [08:29:03] Building sparse matrix (vectorized)...
#> [08:29:03] Replacement appearances: 0 offense, 0 defense
#> [08:29:04] Design matrix: 162 rows, 100 player columns (+2 replacement), 5 covariates
...
#> [08:29:04] Fitting RAPM: 162 observations, 105 columns
#> [08:29:04] RAPM fit complete (xG-based). Lambda.min: 140.1164, R^2: 0.840
...
#> [08:29:04] Fitting SPM model with 6 predictors on 51 players
#> [08:29:04]   Weighting by minutes (sqrt transform)
#> [08:29:04] SPM fit complete. R-squared: 0.000 (weighted in-sample)
...
#> [08:29:04] Fitting panna model with SPM prior...
#> [08:29:04] Panna ratings calculated for 105 players
