...
#> [23:32:54] Processing 66 splints...
#> [23:32:54] Including 50 players (>= 45 minutes)
#> [23:32:54] Replacement pool: 0 players (< 45 minutes)
#> [23:32:54] Building row data (vectorized)...
#> [23:32:54] Building sparse matrix (vectorized)...
#> [23:32:54] Replacement appearances: 0 offense, 0 defense
#> [23:32:55] Design matrix: 132 rows, 100 player columns (+2 replacement), 5 covariates
...
#> [23:32:55] Fitting RAPM: 132 observations, 105 columns
#> [23:32:55] RAPM fit complete (xG-based). Lambda.min: 143.3328, R^2: 0.778
...
#> [23:32:55] Fitting SPM model with 6 predictors on 51 players
#> [23:32:55]   Weighting by minutes (sqrt transform)
#> [23:32:55] SPM fit complete. R-squared: 0.000 (weighted in-sample)
...
#> [23:32:55] Fitting panna model with SPM prior...
#> [23:32:55] Panna ratings calculated for 105 players
