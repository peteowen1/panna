...
#> [01:48:09] Processing 66 splints...
#> [01:48:09] Including 50 players (>= 45 minutes)
#> [01:48:09] Replacement pool: 0 players (< 45 minutes)
#> [01:48:09] Building row data (vectorized)...
#> [01:48:09] Building sparse matrix (vectorized)...
#> [01:48:09] Replacement appearances: 0 offense, 0 defense
#> [01:48:10] Design matrix: 132 rows, 100 player columns (+2 replacement), 5 covariates
...
#> [01:48:10] Fitting RAPM: 132 observations, 105 columns
#> [01:48:10] RAPM fit complete (xG-based). Lambda.min: 143.3328, R^2: 0.778
...
#> [01:48:10] Fitting SPM model with 6 predictors on 51 players
#> [01:48:10]   Weighting by minutes (sqrt transform)
#> [01:48:10] SPM fit complete. R-squared: 0.000 (weighted in-sample)
...
#> [01:48:10] Fitting panna model with SPM prior...
#> [01:48:10] Panna ratings calculated for 105 players
