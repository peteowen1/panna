...
#> [01:32:42] Processing 81 splints...
#> [01:32:42] Including 50 players (>= 45 minutes)
#> [01:32:42] Replacement pool: 0 players (< 45 minutes)
#> [01:32:42] Building row data (vectorized)...
#> [01:32:42] Building sparse matrix (vectorized)...
#> [01:32:42] Replacement appearances: 0 offense, 0 defense
#> [01:32:43] Design matrix: 162 rows, 100 player columns (+2 replacement), 5 covariates
...
#> [01:32:43] Fitting RAPM: 162 observations, 105 columns
#> [01:32:43] RAPM fit complete (xG-based). Lambda.min: 140.1164, R^2: 0.840
...
#> [01:32:43] Fitting SPM model with 6 predictors on 51 players
#> [01:32:43]   Weighting by minutes (sqrt transform)
#> [01:32:43] SPM fit complete. R-squared: 0.000 (weighted in-sample)
...
#> [01:32:43] Fitting panna model with SPM prior...
#> [01:32:43] Panna ratings calculated for 105 players
