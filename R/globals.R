...
utils::globalVariables(c(
  ...
  # Match prediction pipeline columns
  "points",
  "offense",
  "defense",
  "home_sum_panna",
  ...
  # Estimated skills NSE columns (from R CMD check)
  ".mins_90",
  ".w_rate",
  ".wnum",
  ".wden",
  ...
  # PSV columns (per-game player stat value)
  "psv_raw",
  "psv",
  "osv",
  "dsv",

  # WPA columns (win probability added)
  "wp",
  "wp_next",
  "wp_label",
  "wpa",
  ...
  # Per-game EPV aggregation columns
  "epv_offensive",
  "epv_defensive",
  "epv_adj",
  "epv_offensive_adj",
...
utils::globalVariables(c(
  "value_own", "play_type", "net_goals", "ng_recon", "pre", "owed", "got", "tot", "s", "games", "n", "bucket"
))
