...
## SPM Value (box-score value, Wave 3)

Per-match statistical value from box-score coefficients
...
Possession chain construction and aggregation
...
Pairwise knockout-matchup lookup for UCL/UEL/UECL (club-cup sibling of
the World Cup’s build_knockout_lookup)

- [`build_cup_pairwise_lookup()`](https://peteowen1.github.io/panna/reference/build_cup_pairwise_lookup.md)
  : Build a pooled-only, two-legged pairwise knockout lookup for one
  UEFA cup
...
Data-bus utilities for release publish/download integrity
(ECOSYSTEM-FIX-PLAN.md versebus pattern)
...
- [`vb_read_prev_manifest()`](https://peteowen1.github.io/panna/reference/vb_read_prev_manifest.md)
  : Previous manifest or NULL on first publish (transient errors
  propagate)
