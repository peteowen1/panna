...
Raised from 30 -\> 50 on 2026-04-18: with second-precision splint
creation and 5-min boundary-merge minimum, the per-splint zero-xG
baseline rose (shorter splints naturally have fewer shots). 50% only
catches genuine bad-data league-seasons rather than penalising
fine-grained splits.
