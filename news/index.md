...
- Not the whole match dataset: ~170 columns × 58k rows is a large asset
  to publish for a diagnostic, and the strength subset plus outcomes is
  what the open questions actually need.
