...
In production, you would load data with `load_opta_stats()`, `load_opta_match_events()`, etc.
Here we generate synthetic match data that mirrors the structure of processed Opta data.
