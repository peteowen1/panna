...
Opta is the primary data source with 263 columns per player across 15 leagues. It powers the full RAPM/SPM pipeline, EPV, xMetrics, estimated skills, and match predictions.
...
- [Data Sources](data-sources.html) - Detailed comparison of Opta, Understat, and FBref
